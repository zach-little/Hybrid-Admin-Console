...
- Native Active Directory writes passed non-production lab validation for manager, group membership, account enable/disable, password, object move, and ordinary allowlisted attribute paths.
...
- Non-production live validation for retained Graph, Exchange Online, and Exchange on-premises capabilities.
