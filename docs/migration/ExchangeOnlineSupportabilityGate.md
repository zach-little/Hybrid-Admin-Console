...
| Operation | Current HILOP Use | Native Public Surface | Disposition |
| --- | --- | --- | --- |
...
- Whether to remove/defer Exchange mailbox delegation editing from first-party native HILOP.
