...
public sealed class RuntimeProfileSelectorViewModel : INotifyPropertyChanged
{
    ...
    private bool _hasLoadedLicensingStatus;
    ...
    public LicensingStatus LicensingStatus
    {
        ...
        private set
        {
            if (SetField(ref _licensingStatus, value))
            {
                ...
                OnPropertyChanged(nameof(ShouldAutoPromptForLicense));
            }
        }
    }

    public bool HasLoadedLicensingStatus
    {
        get => _hasLoadedLicensingStatus;
        private set
        {
            if (SetField(ref _hasLoadedLicensingStatus, value))
            {
                OnPropertyChanged(nameof(ShouldAutoPromptForLicense));
            }
        }
    ...
    public bool ShouldAutoPromptForLicense =>
        HasLoadedLicensingStatus &&
        LicensingStatus.State == LicenseState.Unlicensed &&
        LicensingStatus.License is null;
