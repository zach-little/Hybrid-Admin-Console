...
if (-not (Test-Path -LiteralPath $uiPath)) { throw "HILOP Console UI script not found: $uiPath" }
if (-not (Test-Path -LiteralPath $iconPath)) { throw "HILOP application icon not found: $iconPath" }
